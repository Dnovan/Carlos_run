  ...
  // List of all the image assets.
    ...
    Future<void> onLoad() async {
      ...
      await images.loadAll(_imageAssets);
          ...
          await _loadParallaxBackground('forest');
        }
      
        Future<void> _loadParallaxBackground(String level) async {
          if (parallaxBackground != null && camera.backdrop.contains(parallaxBackground!)) {
            camera.backdrop.remove(parallaxBackground!);
          }
          ...
          for (final imageName in imageNames) {
            parallaxImages.add(ParallaxImageData('$folder/$imageName'));
          }
        ...
        Future<void> startGamePlay(String level) async {
          currentLevel = level;
          await _loadParallaxBackground(level);
        ...
        void reset() {
          ...
          _loadParallaxBackground('forest');
        }
